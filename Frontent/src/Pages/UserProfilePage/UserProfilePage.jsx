              ...
              <div className={"theme-option " + theme}>
                {
                  theme === 'dark' ?
                    // moon svg
                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" className="moon-svg bi bi-moon-stars" viewBox="0 0 16 16">
                    ...
                    :
                    // sun svg
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="sun-svg bi bi-brightness-high" viewBox="0 0 16 16">
