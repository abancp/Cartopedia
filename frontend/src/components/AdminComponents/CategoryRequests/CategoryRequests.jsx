                                        ...
                                        companyRequiests.map((request, index) => (
                                            <tr key={index} >
                                                ...
                                                <td>
                                                    ...
                                                    <svg onClick={() => { handleAccept(true, request.name) }} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="admin-compony-request-table-tick-svg bi bi-check-circle-fill" viewBox="0 0 16 16">
